...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/zeus-mcmc-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12712&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/zeus-mcmc-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `zeus-mcmc` can be installed with:

```
conda install zeus-mcmc
```

It is possible to list all of the versions of `zeus-mcmc` available on your platform with:
